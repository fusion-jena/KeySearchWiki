...
KeySearchWiki consists of 16,623 queries and their corresponding relevant Wikidata entities.
...
The dataset generation workflow is explained in detail in the paper and the steps needed to reproduce the current dataset or generate a new dataset version is described under [Dataset Generation](#dataset-generation).
Furthermore, a concrete use case of the dataset is demonstrated under [Experiments](#experiments)
...
The KeySearchWiki dataset is published on [Zenodo](https://doi.org/10.5281/zenodo.5751978) in two different formats: Standard [TREC format](https://trec.nist.gov/data/qrels_eng/) and JSON format.
...
Used queries and qrels files can be found respectively under: `KeySearchWiki-experiments/queries` and `KeySearchWiki-experiments/qrels` in [KeySearchWiki-experiments](https://doi.org/10.5281/zenodo.5761138).
...
<table>
  ...
  <tr>
	...
	<td >0.014</td><td ><b>0.031</b></td>
  </tr>
  <tr>
  <td ><b>DFR</b></td>
  <td >0.210</td><td >0.211</td>
  <td >0.023</td><td >0.021</td>
